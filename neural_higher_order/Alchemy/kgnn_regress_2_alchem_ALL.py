...
class ZINC(InMemoryDataset):
    ...
    def raw_file_names(self):
        return "ZINC_adllrrrrrdrjtdvfv10kd"

    @property
    def processed_file_names(self):
        return "ZINC_alfrrrrldrtrjrvv1dd0kd"
    ...
    def process(self):
        ...
        print("###")
        matrices = kb.get_all_matrices("alchemy_full", list(range(202579)))
...
for _ in range(5):
    ...
    dataset = ZINC(path, transform=MyTransform()).shuffle()
    print(len(dataset))
...
with open('plot_alchem_2_all', 'wb') as fp:
