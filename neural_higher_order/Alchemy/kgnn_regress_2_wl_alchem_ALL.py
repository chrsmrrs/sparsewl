...
class ZINC_wl(InMemoryDataset):
    ...
    def raw_file_names(self):
        return "ZINC_gwfsfddfhfl"

    @property
    def processed_file_names(self):
        return "ZINC_wfgfldfffshs"
    ...
    def process(self):
        ...
        print("###")
        matrices = kb.get_all_matrices_wl("alchemy_full", list(range(202579)))
...
for _ in range(5):
    ...
    dataset = ZINC_wl(path, transform=MyTransform()).shuffle()
    print(len(dataset))
...
with open('plot_alchem_wl_all', 'wb') as fp:
